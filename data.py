...
class Data:
    ...
    def read_and_process_features(self):
        ...
        feature_df.drop(['lat', 'lon', 'provider', 'electricity', 'opening_hours',
                         ...
                         'beach', 'river', 'residential', 'retail', 'industrial'], axis=1, inplace=True)
        ...
        scaler = MinMaxScaler()
        feature_df[['anschlusse', 'power', 'current', 'park_area', 'railway', 'airport', 'sea', 'commercial']] = \
            scaler.fit_transform(feature_df[['anschlusse', 'power', 'current', 'park_area', 'railway', 'airport', 'sea', 'commercial']])
